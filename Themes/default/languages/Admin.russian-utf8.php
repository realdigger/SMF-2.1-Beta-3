...
$txt['attachment_files'] = 'Доступно еще файлов';
...
$txt['email_preview_warning'] = 'Предпросмотр точен не на 100%. Для сохранения разметки этой страницы, обрабатываются только базовые html тэги';
$txt['email_as_html'] = 'Отправлять в HTML-формате (тогда можно будет использовать тэги HTML в e-mail.)';
...
$txt['ban_trigger_browse_description'] = 'Здесь показаны все логи банов, сгруппированные по IP, имени хоста, e-mail и по имени пользователя.';

$txt['ban_log'] = 'Логи банов';
$txt['ban_log_description'] = 'В логе банов показаны все попытки входа на форум заблокированных пользователей (только \'полный бан\' и \'без возможности зарегистрироваться\').';
...
$txt['errlog_desc'] = 'Журнал ошибок содержит записи обо всех обнаруженных в работе форуме ошибках. Для удаления записи об ошибке, выберите ее и нажмите кнопку %1$s внизу страницы.';
...
$txt['attachment_image_reencode_note'] = '(требуется GD-модуль или ImageMagick с расширением IMagick или MagickWand)';
...
$txt['attach_dir_desc'] = 'Создавайте новые папки или изменяйте существующие в секции ниже. <br>Чтобы создать новую новую папку в корневой папке форума, просто введите ее имя. <br>Чтобы удалить папку, сотрите путь в поле ввода. Только опустые папки могут быть удалены. Чтобы удостоверится, что папка пустая, проверьте указанное в скобках количество файлов или вложенных папок. <br> Чтобы переименовать папку, просто измените ее имя в поле ввода. Только папки без вложенных папок могут быть переименованы.';
$txt['attach_dir_base_desc'] = 'Ниже, вы можете изменить базовую папку или создать новую. Новые базовые директории будут добавлены в список папок вложений. Так же, вы можете назначить существующую папку базовой.';
$txt['attach_dir_save_problem'] = 'Похоже, здесь есть проблема.';
$txt['attachments_no_create'] = 'Невозможно создать новую папку вложений. Сделайте это, используя фтп или файл менеджер панели хостинга.';
$txt['attachments_no_write'] = 'Эта папка создана, но недоступна для записи.  Сделайте это, используя фтп или файл менеджер панели хостинга.';
...
$txt['attach_dir_base_no_create'] = 'Невозможно создать. Проверьте, правильно ли указан путь. Или создайте папку используя фтп или файл менеджер панели хостинга.';
...
$txt['attach_dir_no_delete'] = 'Не может быть удалена, так как не пустая. Сделайте это, используя фтп или файл менеджер панели хостинга.';
...
$txt['avatar_reencode_note'] = '(требуется GD-модуль или ImageMagick с расширением IMagick или MagickWand)';
...
$txt['gravatarAllowExtraEmail'] = 'Разрешить использование дополнительного e-mail для Граватара?';
...
$txt['gravatarDefault'] = 'Выберите стиль по умолчанию, когда у e-mail пользователя нет привязанного Граватара ';
...
$txt['managedrafts_submit'] = 'Сохранить';
...
$txt['admin_news_select_email_desc'] = 'Список e-mail адресов, разделенных точкой с запятой, на которые будут отправляться уведомления (например address1@email.tld; address2@email.tld). Это дополнение к группам указанным ниже.
';
...
$txt['hooks_disable_instructions'] = 'Кликните на иконку статуса, что включить /выключить хук';
...
$txt['likes_view'] = 'Группы которым разрешено видеть лайки';
