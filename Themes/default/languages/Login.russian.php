...
$txt['login_below_or_register'] = 'Авторизуйтесь или <a href="%1$s">зарегистрируйтесь</a> на %2$s';
...
$txt['login_hash_error'] = 'Политика безопасности паролей была изменена. Введите свой пароль еще раз, чтобы обновить его.';
...
$txt['invalid_activation_new'] = 'Если при регистрации был указан неправильный email, введите новый и укажите свой пароль.';
