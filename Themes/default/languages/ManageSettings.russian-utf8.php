...
$txt['httponlyCookies'] = 'Сделать cookies доступными только через HTTP протокол';
...
$txt['recaptcha_configure_desc'] = 'Настройки reCAPTCHA. Если у вас еще нет ключа для reCAPTCHA, <a href="https://www.google.com/recaptcha/admin">можно получить его здесь</a>.';
...
$txt['setup_verification_add_answer'] = 'Добавить еще один ответ';
...
$txt['setting_warning_show_note'] = 'Задает, кто может видеть уровень предупреждений пользователей.';
...
$txt['add_language_smf_found'] = 'Следующие языки были найдены. Нажмите на ссылку "Установить" для установки выбранного языка, после чего вас перенаправит в менеджер пакетови.';
...
$txt['tfa_mode_forced_help'] = 'Сначала, включите двухфакторную авторизацию для своей учетной записи, если хотите получить возможность принудительно включить ее для других пользователей!';
$txt['tfa_mode_enabled'] = 'Включена';
$txt['tfa_mode_disabled'] = 'Выключена';
$txt['tfa_mode_subtext'] = 'Разрешить пользователям использовать дополнительный уровень безопасности при входе на форум, им потребуется дополнительное приложение, такое как Google Authenticator, спаренное с их учетной записью';
