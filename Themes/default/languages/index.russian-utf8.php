...
$txt['notify_announcements'] = 'Разрешить администраторам отправлять мне важные новости по email';
...
$txt['watching_this_topic'] = 'Вы следите за этой темой будете получать уведомления о ней.';
$txt['notify'] = 'Уведомлять';
$txt['unnotify'] = 'Не уведомлять';
$txt['notify_request'] = 'Хотите получать уведомления по e-mail при появлении новых ответов в этой теме?';
// Use numeric entities in the below string.
...
$txt['issue_warning'] = 'Сделать предупреждение';
...
$txt['welcome_guest_activate'] = '<br>Не получили <a href="' . $scripturl . '?action=activate">письмо для активации учетной записи</a>?';
...
$txt['maintenance_page'] = 'Вы можете отключить режим Техобслуживания в разделе <a href="%1$s">Настройки сервера</a>.';
...
$txt['shortcuts'] = 'подсказка: нажмите alt+s, чтобы подтвердить/отправить или alt+p для предварительного просмотра сообщения';
...
$txt['shortcuts_drafts'] = ', alt+d для сохранения черновика';
$txt['shortcuts_drafts_firefox'] = ', shift+alt+d для сохранения черновика';
...
$txt['not_removed_extra'] = '%1$s это резервная копия для %2$s, которая была создана не форумом. Она доступна напрямую и может использоваться для получения несанкционированного доступа к вашему форуму. Следует удалить ее немедленно.';
...
$txt['mergetopic_redirect'] = 'Перенаправление в объединенныую тему';
$txt['merge_topic_unapproved_js'] = 'Внимание! Эта тема еще не была одобрена.\\n\\nНе рекомендуется создавать тему перенаправления если, только, вы не собираетесь одобрить сообщение сразу после объединения.';
...
$txt['you_likes_1'] = 'Вам и еще <a href="%1$s">%2$s пользователю</a> нравится это сообщение.';
$txt['you_likes_n'] = 'Вам и еще <a href="%1$s">%2$s пользователям</a> нравится это сообщение.';
...
$txt['new_posts_in_category'] = 'Кликните для просмотра новых сообщений в категории %1$s';
...
$txt['activate_changed_email_title'] = 'E-mail адрес изменен';
$txt['activate_changed_email_desc'] = 'Вы изменили свой e-mail адрес. Для его активации, перейдите по ссылке в полученном письме.';
...
$txt['send_email_disclosed'] = 'Обратите внимание: ваш e-mail адрес будет виден получателю.';
...
// Editor prompt.
$txt['prompt_text_email'] = 'Введите e-mail адрес.';
$txt['prompt_text_ftp'] = 'Введите ftp адрес';
$txt['prompt_text_url'] = 'Введите адрес (URL) ссылки.';
$txt['prompt_text_img'] = 'Ведите адрес (URL) картинки.';
...
$txt['are_sure_mark_read'] = 'Уверены, что хотите отметить сообщения как прочитанные?';
...
$txt['notify_topic_1'] = 'Без уведомлений по e-mail и оповещений';
$txt['notify_topic_2'] = 'Получать оповещения';
$txt['notify_topic_3'] = 'Получать e-mail уведомления и оповещения';
$txt['notify_topic_0_desc'] = 'Вы не будете получать ни уведомлений по e-mail, ни оповещений для этой темы, также, эта тема не будет отображаться в непрочитанных ответах и новых темах. За исключением, случаев упоминания вас другими пользователями через @ник.';
$txt['notify_topic_1_desc'] = 'Вы не будете получать ни уведомлений по e-mail, ни оповещений для этой темы, за исключением, случаев упоминания вас другими пользователями через @ник.';
$txt['notify_topic_2_desc'] = 'Вы будете получать оповещения для этой темы.';
$txt['notify_topic_3_desc'] = 'Вы будете получать уведомления по e-mail и оповещения для этой темы.';
$txt['notify_board_1'] = 'Без уведомлений по e-mail и оповещений';
$txt['notify_board_2'] = 'Получать оповещения';
$txt['notify_board_3'] = 'Получать уведомления по e-mail и оповещения';
$txt['notify_board_1_desc'] = 'Вы не будете получать ни уведомлений по e-mail, ни оповещений для этого раздела.';
$txt['notify_board_2_desc'] = 'Вы будете получать оповещения для этого раздела.';
$txt['notify_board_3_desc'] = 'Вы будете получать уведомления по e-mail и оповещения для этого раздела.';
