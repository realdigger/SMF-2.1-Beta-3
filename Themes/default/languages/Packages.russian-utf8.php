...
$txt['sql_file'] = 'Файлы пакета были извлечены, но для дальнейшей работы необходимо выполнить SQL-запрос, который внесет изменения в базу данных.';
...
$txt['package_delete_list_warning'] = 'Уверены, что хотите очистить список установленных модификаций?';
$txt['php_safe_mode'] = 'Извините, PHP на вашем сервере запущен в безопасном режиме (SAFE MODE). Эта функция несовместима с SAFE MODE. Извините.';
...
$txt['avatars_extracted'] = 'Аватары были извлечены, теперь их можно использовать.';
$txt['language_extracted'] = 'Языковой пакет был установлен, теперь его можно использовать.';
...
$txt['packages_adding'] = 'Вы всегда можете найти новые моды для вашего форума в официальном каталоге модификаций SMF - <strong><a href="http://custom.simplemachines.org/mods/" target="_blank">http://custom.simplemachines.org/mods/</a></strong>. Вы можете просматривать описания, читать комментарии и загружать их на свой компьютер для последующей установки на форум.<br><br> Если у вас возникнут вопросы по какой-то модификации, то каждая из имеет отдельную тему для поддержки и комментариев.';
...
$txt['package_will_fail_warning'] = 'По крайней мере, одна ошибка возникла при тесте %1$s пакета.<br /><strong>Настоятельно</strong> не рекомендуется продолжать процесс %1$s, если не уверены в своих действиях, или не произвели резервное копирование данных.<br /><br />Эта ошибка может возникнуть при несовместимости уже установленного пакета с пакетом, который пытаетесь поставить, из-за ошибки в самом пакете, из-за того, что пакет требует наличие другого пакета, который не установлен на форуме, или пакет разработан для другой версии форума SMF.';
$txt['package_will_fail_unknown_action'] = 'Данный пакет пытается осуществить неизвестное действие: %1$s';
// Don't use entities in the below string.
$txt['package_will_fail_popup'] = 'Уверены, что хотите продолжить установку этого пакета, даже если она не будет успешной?';
$txt['package_will_fail_popup_uninstall'] = 'Уверены, что хотите продолжить удаление этого пакета, даже если оно не будет успешным?';
...
$txt['package_other_themes_desc'] = 'Для использования мода в других темах оформления менеджер пакетов должен сделать дополнительные изменения. Пожалуйста, поставьте галочки напротив нужных изменений.';
// Don't use entities in the below string.
...
$txt['package_uninstall_cannot'] = 'Данный пакет не может быть удален, поскольку не найдена информация по удалению.<br /><br />Пожалуйста, свяжитесь с автором мода и сообщите об этой проблеме.';
...
$txt['package_install_options_make_full_backups'] = 'Создавать полную копию (исключая смайлики, аватары и вложения) файлов форума.';

$txt['package_ftp_necessary'] = 'Необходимая информация FTP';
$txt['package_ftp_why'] = 'Некоторые файлы, которые менеджер пакетов должен изменить, не имеют прав на запись. Измените эти права, используя FTP. Для просмотра списка изменяемых файлов кликните <a href="#" onclick="%1$s">здесь</a>.';
$txt['package_ftp_why_file_list'] = 'Следующим файлам нужны права на запись для продолжения установки:';
$txt['package_ftp_why_download'] = 'Для загрузки пакетов, директория для закачивания пакетов должна иметь права на запись. Менеджер пакетов может использовать ваши настройки FTP для установки этих прав.';
...
$txt['package_delete_bad'] = 'Пакет, который вы пытаетесь удалить, установлен на форуме. Если удалить сам пакет, то в дальнейшем будет невозможно удалить данный мод.\\n\\nУверены?';
...
$txt['package_restore_permissions_action_success'] = '<span style="color: green;">Выполнение</span>';
