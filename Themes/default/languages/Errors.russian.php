...
$txt['cannot_send_email_to_members'] = 'Администратором запрещена отправка e-mail в этом разделе.';
...
$txt['post_already_deleted'] = 'Тема или сообщение уже перенесены в корзину. Уверены, что хотите удалить окончательно?. <br>Если да, нажмите <a href="%1$s">здесь</a>';
