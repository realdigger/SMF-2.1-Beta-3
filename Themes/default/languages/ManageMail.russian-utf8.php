...
$txt['mailqueue_clear_list_warning'] = 'Уверены, что хотите отправить все текущие сообщения в очереди? Это превысит все установленные ограничения.';
...
$txt['birthday_email'] = 'Использовать сообщения для поздравлений с днём рождения';
