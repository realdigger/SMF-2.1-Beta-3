...
$txt['scheduled_tasks_time_offset'] = '<strong>Примечание:</strong> все значения времени, указанные ниже, являются <em>серверными</em> и не зависят от смещения, заданного в профиле.';
...
$txt['scheduled_log_empty_log_confirm'] = 'Уверены, что хотите полностью очистить лог?';
