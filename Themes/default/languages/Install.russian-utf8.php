...
$txt['default_topic_message'] = 'Добро пожаловать на форум Simple Machines!<br /><br />Надеемся, вам понравится использование этого форума. При возникновении каких-либо проблем, пожалуйста, обращайтесь на [url=http://www.simplemachines.org/community/index.php]официальный сайт поддержки[/url].<br />Вы также можете посетить [url=http://www.simplemachines.ru/index.php]русскоязычное сообщество SMF[/url].<br /><br />Большое спасибо!<br />Simple Machines';
...
$txt['install_settings_url_info'] = 'Адрес (URL) форума указывается <strong>без \'/\'</strong> в конце.<br />В большинстве случаев можно оставить указанное значение по умолчанию. При желании его можно изменить.';
...
$txt['upgrade_warning_out_of_date'] = 'Скрипт обновления устарел! Последняя версия SMF: <em id="smfVersion" style="white-space: nowrap;">??</em>, а ваша программа обновления для <em id="yourVersion" style="white-space: nowrap;">%1$s</em>.<br /><br />Рекомендуется посетить сайт <a href="http://www.simplemachines.org">Simple Machines</a>, чтобы удостовериться, что обновляетесь на последнюю версию.';
