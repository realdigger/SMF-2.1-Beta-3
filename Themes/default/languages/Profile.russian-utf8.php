...
$txt['popup_ignore'] = 'Игнорирование пользователей';
...
$txt['gravatar_alternateEmail'] = 'Обычно граватар привязан к вашему основному e-mail адресу, но если вы хотите использовать другой e-mail, укажите его здесь.';
$txt['gravatar_noAlternateEmail'] = 'Отображаемый граватар будет связан с вашим основным e-mail адресом.';
...
$txt['email_change_logout'] = 'Если вы измените свой e-mail, вам потребуется заново активировать свой аккаунт. Сейчас вы принудительно выйдете с форума.';
...
$txt['receive_mail'] = 'Получать email';
$txt['alert_group_board'] = 'Разделы и темы';
$txt['alert_group_msg'] = 'Сообщения';
$txt['alert_opt_pm_notify'] = 'Если включено, уведомления на e-mail для:';
...
$txt['alert_opt_msg_receive_body'] = 'Присылать текст сообщения в e-mail';
...
$txt['registration_not_approved'] = 'Извините, данная учетная запись пока не одобрена. Если хотите изменить свой e-mail, пожалуйста, нажмите <a href="%1$s">здесь</a>.';
$txt['registration_not_activated'] = 'Извините, данная учетная запись пока не активирована. Если необходимо повторно отправить письмо с кодом активации, пожалуйста, нажмите <a href="%1$s">здесь</a>';
...
$txt['use_editor_quick_reply'] = 'Использовать полный редактор в форме быстрого ответа';
...
$txt['report_profile'] = 'Пожаловаться на этого пользователя';
...
$txt['tfa_pass_invalid'] = 'Введен неправильный пароль, попробуйте еще раз.';
$txt['tfa_code_invalid'] = 'Введен неправильный код, попробуйте еще раз.';
$txt['tfa_backup_invalid'] = 'Введен неправильный код восстановления, попробуйте еще раз.';
$txt['tfa_backup_title'] = 'Сохраните этот код восстановления в надежном месте!';
$txt['tfa_backup_used_desc'] = 'Вы ввели верный код восстановления и двухфакторная авторизация отключена. Если вы хотите использовать двухфакторную авторизацию снова, включите ее здесь';
...
$txt['tfa_backup_desc'] = ' В случае утери спаренного устройства или приложения для авторизации, вы сможете использовать код восстановления, заданный при настройке двухфакторной авторизации. В случае утери и этого кода, свяжитесь с администратором форума.';
