...
$txt['paypal_additional_emails'] = 'Основной email адрес для PayPal';
...
$txt['paid_note'] = '<strong class="alert">Примечание:</strong><br>Для автоматически продляемых подписок необходимо установить URL-адрес для каждого из способов оплаты. Для всех типов оплаты этот URL-адрес должен быть задан как:<br><br>
	&bull; <strong>' . $boardurl . '/subscriptions.php</strong><br><br>
	Можно изменить ссылку на PayPal, кликнув <a href="https://www.paypal.com/us/cgi-bin/webscr?cmd=_profile-ipn-notify" target="_blank">здесь</a>.<br>
	Для других шлюзов (если они установлены) нужный адрес можно найти в панели клиента &mdash; обычно это пункты "Return URL" ("Возвращаемый URL") или "Callback URL" ("Обратный URL").';
...
SMF использует <strong>PayPal</strong> как платежный метод по умолчанию.<br>
	...
	&bull; Вы должны предоставить свой основной e-mail адрес PayPal для подтверждения аккаунта.<br><br>
...
$txt['paid_mod_cost_cad'] = 'Стоимость (CAD)';
$txt['paid_mod_cost_aud'] = 'Стоимость (AUD)';
