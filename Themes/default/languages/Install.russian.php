...
$txt['default_topic_message'] = 'Добро пожаловать на форум Simple Machines!<br><br>Надеемся, вам понравится использование этого форума. При возникновении каких-либо проблем, обращайтесь на [url=http://www.simplemachines.org/community/index.php]официальный сайт поддержки[/url].<br>Вы, также, можете посетить [url=http://www.simplemachines.ru/index.php]русскоязычное сообщество SMF[/url].<br><br>Большое спасибо!<br>Simple Machines';
...
$txt['install_settings_url_info'] = 'Адрес (URL) форума указывается <strong>без \'/\'</strong> в конце.<br>В большинстве случаев, можно оставить указанное значение по умолчанию.';
...
$txt['install_settings_reg_email'] = 'Активация по e-mail';
...
$txt['user_settings_admin_email'] = 'Email адрес Администратора';
$txt['user_settings_admin_email_info'] = 'Укажите ваш email. Это должен быть действительный адрес!';
$txt['user_settings_server_email'] = 'Email Веб-мастера';
$txt['user_settings_server_email_info'] = 'Укажите <strong>email адрес от имени которого форум будет отправлять уведомления</strong>. Это должен быть действительный адрес!';
...
$txt['error_user_settings_taken'] = 'Пользователь с таким именем и/или e-mail адресом уже зарегистрирован.<br><br>Учетная запись не создана.';
...
$txt['error_mod_security'] = 'Программа установки обнаружила установленный модуль mod_security. Этот модуль будет блокировать передающиеся формами данные. SMF форум имеет встроенный сканер безопасности, который превосходит по возможностям этот модуль и работает намного эффективней.<br><br><a href="http://www.simplemachines.org/redirect/mod_security">Информация по отключению mod_security</a>';
$txt['error_mod_security_no_write'] = 'Программа установки обнаружила установленный модуль mod_security. Этот модуль будет блокировать передающиеся формами данные. SMF форум имеет встроенный сканер безопасности, который превосходит по возможностям этот модуль и работает намного эффективней.<br><br><a href="http://www.simplemachines.org/redirect/mod_security">Информация по отключению mod_security</a><br><br>Также, вы можете сделать файл .htaccess доступным для записи, изменив права доступа  (chmod 777) используя фтп-клиент и обновить эту страницу.';
...
$txt['upgrade_error_script_js'] = 'Программа обновления не может найти файл script.js, либо он устарел. Убедитесь, что настройки путей для вашей темы оформления указаны правильно. Используйте утилиту <a href="http://download.simplemachines.org/index.php?thanks;filename=repair_settings.php" target="_blank">repair_settings</a> для проверки настроек.';
