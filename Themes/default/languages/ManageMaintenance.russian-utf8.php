...
$txt['maintain_recountposts_info'] = 'Запусите эту задачу, чтобы пересчитать количество сообщений пользователей. Будут пересчитаны все доступные сообщения сделанные каждым пользователем и обновлены счетчики сообщений в профилях';

$txt['safe_mode_enabled'] = '<a href="http://php.net/manual/en/features.safe-mode.php">safe_mode</a> включен на вашем сервере!<br>Резервная копия сделанная здесь не может считаться надежной!';
...
$txt['enable_maintenance1'] = 'Из-за большого размера форума рекомендуется переключить форум в "режим техобслуживания" перед созданием резервной копии.';
$txt['enable_maintenance2'] = 'Из-за большого размера форума, чтобы продолжить, переключите форум в "режим техобслуживания".';
