...
$helptxt['moderator_why_missing'] = 'Так как, модераторы назначаются в конкретные разделы, Вы можете назначить их с помощью <a href="%1$s?action=admin;area=manageboards" target="_blank" class="new_win">интерфейса управления разделами</a>.';
