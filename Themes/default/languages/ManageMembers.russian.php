...
$txt['membergroups_confirm_delete_mod'] = 'Эта группа назначена как группа Модераторов для одного или нескольких разделов. Уверены, что хотите удалить ее?';
$txt['membergroups_swap_mod'] = 'Эта группа назначена как группа Модераторов для одного или нескольких разделов. Если изменить ее тип на группу зависящую от количества сообщений, она перестанет быть группой Модераторов для тех разделов.';
