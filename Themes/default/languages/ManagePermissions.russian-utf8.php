<?php
// Version: 2.1 Beta 3; ManagePermissions
...
$txt['permissionname_profile_other'] = 'Редактирование ссылки на сайт';
$txt['permissionhelp_profile_other'] = 'Позволяет редактировать в профиле ссылку на свой сайт.';
$txt['permissionname_profile_other_own'] = 'Свой профиль';
...
$txt['permissiongroup_profile_account'] = 'Учетные записи';
...
$txt['permissionname_profile_password'] = 'Менять пароль';
...
$txt['permissionname_report_user'] = 'Отправлять жалобы на профили пользователей';
